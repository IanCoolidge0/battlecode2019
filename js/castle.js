...
function emergency_defense(r) {
    ...
    r.buildQueue.push({unit: SPECS.PROPHET,karbonite:25, fuel: 50});
    r.prophetQueue.push({x:unitLocation.x, y: unitLocation.y, code: constants.PROPHET_JOBS.DEFEND_GOAL});
